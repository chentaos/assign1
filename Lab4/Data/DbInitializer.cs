...
namespace Lab4.Data
{
    public static class DbInitializer
    {
        public static void Initialize(SchoolCommunityContext context)
        {
            ...
            //{
            //    foreach (var entity in context.Communities)
            ...
            //{
            //    foreach (var entity in context.CommunityMemberships)
            //        context.CommunityMemberships.Remove(entity);
            //    context.SaveChanges();
            //}
            ...
            new CommunityMembership{StudentID=4,CommunityID="A1"}
            };
